...
insert into `datospersonales`(Dni, Cuil, Nombre, Apellido, Sexo, FechaNacimiento, Direccion, FK_Nacionalidad, FK_idTelefono) values (1,1,'Jorge','Bacque','masculino',('1987-07-22'),'Olazabal 479',12,1);
