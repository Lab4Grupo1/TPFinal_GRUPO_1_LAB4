			...
			<div class="col">
				...
				<div class=".container table-responsive-md">
					<form class="formBusqueda" style="display: flex;"
						action="servletclientesPagos" method="get">
						<input type="number" class="form-control col-md-3"
							name="txtNprestamo" required> <input type="submit"
							class="btn btn-outline-primary" value="Buscar"
							name="btnBuscarPrest" style="margin-left: 10px;">
					</form>
					<br>
					<%
					...
					<table id="table1"
						...
						<tbody>
							<tr>
								...
								<td><a href="clientePagos.jsp" class="btn btn-primary"
									role="button" aria-disabled="true">Pagar</a></td>
